...
$sendTo = 'Contacto <informacion@finestra.mx>';
$subject = 'Nuevo mensaje desde Finestra.mx';
$fields = array('name' => 'Nombre', 'surname' => 'Surname', 'phone' => 'Teléfono', 'email' => 'Email', 'comentarios' => 'Comentarios', 'check' => 'Suscribirme a Newsletter'); // array variable name => Text to appear in the email
